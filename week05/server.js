  ...
  .createServer((request, response) => {
    ...
    request
      ...
      .on("end", () => {
        ...
        // )
        response.end(
          `<html lang="cn"><head><style>#container{display:flex; width:500px;height:300px;background-color:rgb(0,255,255);}#myid{width:200px;height:100px;background-color:rgb(255,0,0);}.c1{flex:1;background-color:rgb(0,255,0);}.c1>div{color:red}</style></head><body><div id="container"><div id="myid"></div><div class="c1"><div></div></div></div></body></html>`
        )
      })
  })
  .listen(8088)
